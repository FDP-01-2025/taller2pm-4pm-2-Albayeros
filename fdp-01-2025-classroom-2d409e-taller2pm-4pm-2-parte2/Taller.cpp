...
void modificarEstudiante() {
   ...
   ofstream temp("temp.txt");  
    ...
    cout << "Porfavor escriba el carnet del estudiante a modificar: " << endl;
    cin >> carnet_busc;
    ...
    if (archivo.is_open() && temp.is_open())
    {
        while (archivo >> e.nombre >> e.carnet >> e.edad)
        {
            if (e.carnet == carnet_busc)
            {
                cout << "Porfavor escriba el nuevo nombre del estudiante: " << endl;
                cin >> nombre_mod;

                cout << "Porfavor escriba la nueva edad del estudiante: " << endl;
                cin >> edad_mod;

                temp << nombre_mod << " " << e.carnet << " " << edad_mod << endl;
                encontrado = true;
                cout << "El estudiante ha sido modificado con exito!." << endl;
    ...
    if (!encontrado)
    {
        cout << "No se ha encontrado ningun carnet coincidente con el ingresado." << endl;
    }
